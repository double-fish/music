<template>
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="direction">
        <li class="left" @click="move(730, 1, speed)">
        ...
        <li class="right" @click="move(730, -1, speed)">
...
export default {
  ...
  data () {
    return {
      sliders:[
        {
          img:require('@/assets/img/LBT/music1.jpg')
        },
        {
          img:require('@/assets/img/LBT/music2.jpg')
        },
        {
         img:require('@/assets/img/LBT/music3.jpg')
        },
        {
          img:require('@/assets/img/LBT/music4.jpg')
        },
        {
          img:require('@/assets/img/LBT/music5.jpg')
        },
      ],
      imgWidth:730,
      currentIndex:1,
  ...
  computed:{
    ...
    interval() {
      return this.initialInterval * 730
    }
  },
  mounted() {
    this.init()
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/730 : this.currentIndex -= offset/730
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -3650) this.distance = -730
          if (des > -730) this.distance = -3650
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1;
      const offset = Math.abs(index - this.currentIndex) * 730;
